...
namespace Cwd
{
    public static class Help
    {
        ...
        public static void Print()
        {
            ...
            Console.WriteLine($"cwd (Copy Working Directory) - Simple as that...{Environment.NewLine}Created by: Krzysztofz01{Environment.NewLine}https://github.com/Krzysztofz01/Cwd{Environment.NewLine}Version: 1.1.1");
